...
export type NavigationMenuElement = React.ComponentRef<
...
export type NavigationMenuListElement = React.ComponentRef<
...
export type NavigationMenuItemElement = React.ComponentRef<
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{' '}
      <ChevronDownIcon
        className="cursor-pointer relative top-px ml-1 size-3 transition duration-300 group-data-[state=open]:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
...
export type NavigationMenuContentElement = React.ComponentRef<
...
export type NavigationMenuViewportElement = React.ComponentRef<
...
export type NavigationMenuLinkElement = React.ComponentRef<
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "cursor-pointer data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent data-[active=true]:bg-accent/50 data-[active=true]:text-accent-foreground hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
...
export type NavigationMenuIndicatorElement = React.ComponentRef<
