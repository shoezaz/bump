...
export const keys = () =>
  createEnv({
    ...
    runtimeEnv: {
      NEXT_PUBLIC_BILLING_PRICE_PRO_MONTH_ID: process.env.NEXT_PUBLIC_BILLING_PRICE_PRO_MONTH_ID,
      NEXT_PUBLIC_BILLING_PRICE_PRO_YEAR_ID: process.env.NEXT_PUBLIC_BILLING_PRICE_PRO_YEAR_ID,
      NEXT_PUBLIC_BILLING_PRICE_LIFETIME_ID: process.env.NEXT_PUBLIC_BILLING_PRICE_LIFETIME_ID,
      NEXT_PUBLIC_BILLING_PRICE_ENTERPRISE_MONTH_ID: process.env.NEXT_PUBLIC_BILLING_PRICE_ENTERPRISE_MONTH_ID,
      NEXT_PUBLIC_BILLING_PRICE_ENTERPRISE_YEAR_ID: process.env.NEXT_PUBLIC_BILLING_PRICE_ENTERPRISE_YEAR_ID,
