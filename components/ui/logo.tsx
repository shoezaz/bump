...
// The logo size below is 28px x 28px (w-7 h-7) but in a 36px x 36px (w-9 h-9) container.
...
export function Logo({
  ...
  return (
    ...
    >
      {!hideSymbol && (
        <div className="flex items-center justify-center w-9 h-9 p-1">
          <div className="flex items-center justify-center w-7 h-7 border rounded-md text-primary">
            <svg
              width="16"
              height="16"
              viewBox="0 0 24 24"
